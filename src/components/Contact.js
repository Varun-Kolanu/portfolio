...
export default function Contact() {
  return (
    ...
    >
      <div id="contactBox" className=" hide w-[1000px]">
        ...
        <div id="contactContainer" className="grid grid-flow-row grid-cols-2">
            <form action="backend.js" className="flex flex-col relative top-5 text-white">
              <input type="text" id="name" placeholder="Your Name" className="bg-transparent my-6 border-b-2 border-b-white focus:outline-none placeholder-cyan-200 font-mono"/>
              <input type="tel" id="phone" placeholder="Mobile No." className="font-mono bg-transparent my-6 border-b-2 border-b-white focus:outline-none placeholder-cyan-200"/>
              <input type="email" id="email" placeholder="Email Id" className="font-mono bg-transparent  my-6 border-b-2 border-b-white focus:outline-none placeholder-cyan-200"/>
              <textarea name="message" id="message" rows="3" cols="10" placeholder="Message..." className="font-mono bg-transparent my-10 border-b-2 border-b-white focus:outline-none placeholder-cyan-200" ></textarea>
            ...
            <div id="rightContact" className="pl-52">
              ...
              <div id="mailSend" className="rounded-lg drop-shadow-lg bg-gradient-to-br from-blue-500 from-30% to-indigo-600 flex flex-col justify-evenly items-center my-5 h-[150px] hover:scale-105 transition-all duration-500">
                ...
                <a href="mailto:kolanuvarun739@gmail.com" target="blank" className="text-white font-bold underline underline-offset-2">Send Mail</a>
              </div>
              ...
              <div id="wtspSend" className="rounded-lg drop-shadow-lg bg-gradient-to-br from-blue-500 from-30% to-indigo-600 flex flex-col justify-evenly items-center my-5 h-[150px] hover:scale-105 transition-all duration-500">
                ...
                <a href="https://api.whatsapp.com/send?phone=9603138312" target="blank" className="text-white font-bold underline underline-offset-2">Send Message</a>
              </div>
               
               <div id="contactLinks" className='relative right-6 flex justify-evenly my-10 w-[300px] text-2xl text-white'>
